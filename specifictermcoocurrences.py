...
# Used for checking the coocurreneces for specific vocabulary
...
# Looking for a specific term and extracting its most frequent co-occurrences
search_word = 'machine' # pass a term as a command-line argument
