# Vincent is for data visualization and is based on Javascript
# Allows us to bridge between Python back-end and front-end that supports D3.js visualization
...
bar.to_json('term_freq.json', html_out=True, html_path='chart.html') # will contain a description of plot that can be handed over to D3.js